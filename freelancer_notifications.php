...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="dashboardfreelance.php">TalentaHub</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link " href="dashboardfreelance.php">Explore</a>
                        </li>
                        <li class="nav-item ">
    ...
    <section class="section-50">
        <div class="container">
            ...
            ?>
                <a href="process_notif_freelancer.php?id=<?php echo $row['id']; ?>"
